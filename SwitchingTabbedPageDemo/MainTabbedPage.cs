...
namespace SwitchingTabbedPageDemo {
	public class MainTabbedPage : TabbedPage {
		...
		public MainTabbedPage() {
			...
			tab2Page = new NavigationPage(new Page2()) {
				Title = "Messages",
			...
			tab3Page = new NavigationPage(new Page3()) {
				Title = "Transactions",
				Icon = "circle" // extension isn't required
			};
			Children.Add(tab3Page);

			tab4Page = new NavigationPage(new Page4()) {
				Title = "Profile",
				Icon = "circle" // extension isn't required
			};
			Children.Add(tab4Page);

			tab5Page = new NavigationPage(new Page5()) {
				Title = "Events",
				Icon = "circle" // extension isn't required
			};
		...
		public void SwitchToTab5(){
			CurrentPage = tab5Page;
	}
	}
}